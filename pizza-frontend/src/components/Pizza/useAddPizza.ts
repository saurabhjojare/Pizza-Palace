// src/components/pizza/AddPizzaSchema.ts
import * as Yup from "yup";
import { PizzaFormValues } from "../../interfaces/Pizza";

export const useAddPizza: Yup.ObjectSchema<PizzaFormValues> = Yup.object({
  name: Yup.string()
